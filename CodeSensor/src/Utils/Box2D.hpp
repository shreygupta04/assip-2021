...
#ifndef Antipatrea__Box2D_HPP_
#define Antipatrea__Box2D_HPP_
...
namespace Antipatrea
{
	...
	virtual void SetupFromParams(Params &params)
	{
	    ...
	    Logger::m_out << "XXXXXXXX" << std::endl << params << std::endl << "XXXXXX"<<std::endl;
	...
	{
	    RndEngine::GetSingleton()->SamplePointInsideBox2D(GetMin(), GetMax(), p);
	}
	...
	{
	    Shape2D::Info(out);
	    out << m_box[0] << " " << m_box[1] << " " << m_box[2] << " " << m_box[3]  << std::endl;
	}
