...
namespace Antipatrea
{
	...
	virtual void AddPolygon(Polygon2D & poly, const double z = 0.0);

	virtual void AddCappedPyramid(Polygon2D &basePoly,
				      Polygon2D &topPoly,
				      double zmin,
				      double zmax);

	virtual void AddSkewedCylinderX(const int n,
	...
	virtual void AddSkewedCylinderY(const int n,
					const double x1, const double y1, const double z1, const double r1,
					const double x2, const double y2, const double z2, const double r2);
	virtual void AddSkewedCylinderZ(const int n,
					const double x1, const double y1, const double z1, const double r1,
					const double x2, const double y2, const double z2, const double r2);
	...
	virtual void DrawColormap(void);
	...
	virtual void SamplePointInsideFace(const int i, double p[]);

	virtual void GetFacesBelow(const double z, std::vector<int> & fids);

	virtual double MaxZIntersect(const double p0[], const double p1[]);
