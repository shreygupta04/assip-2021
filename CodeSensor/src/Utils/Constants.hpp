 ...
 */
	...
	const char KW_FileName[] = "FileName";
	...
	const char KW_PointSize[] = "PointSize";
	...
	const double GRAPHICS_POINT_SIZE = 0.5;	
	...
	const char KW_MoveDistance[] = "MoveDistance";
	
	
	const char KW_NrStacks[] = "NrStacks";
	const char KW_NrSlices[] = "NrSlices";
	const char KW_FontSizes[] = "FontSizes";
	...
	const double SMALL_PROBABILITY = 0.02;

		
//GraphSearch
	const char KW_GraphSearchDFS[] = "GraphSearchDFS";
	const char KW_GraphSearchBFS[] = "GraphSearchBFS";
	const char KW_GraphSearchAStar[] = "GraphSearchAStar";	
	const char KW_BreakEarly[] = "BreakEarly";
	const char KW_UseNodeBest[] = "UseNodeBest";
