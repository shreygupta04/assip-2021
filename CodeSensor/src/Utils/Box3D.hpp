...
#ifndef Antipatrea__Box3D_HPP_
#define Antipatrea__Box3D_HPP_
...
namespace Antipatrea
{
	...
	{
	    RndEngine::GetSingleton()->SamplePointInsideBox3D(GetMin(), GetMax(), p);
	}
	...
	{
	    Shape3D::Info(out);
	    out << m_box[0] << " " << m_box[1] << " " << m_box[2] << " " << m_box[3] << " " << m_box[4] << " " << m_box[5] << std::endl;
	}
