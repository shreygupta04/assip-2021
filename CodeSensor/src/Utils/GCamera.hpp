...
namespace Antipatrea
{
    ...
    {
    public:
	GCamera(void) : m_dmove(Constants::GRAPHICS_CAMERA_MOVE)
	{
	...
	virtual void Print(std::ostream &out)
	{
		...
		<< Constants::KW_MoveDistance << GetMoveDistance() << std::endl;	    
	}
	...
	virtual double GetMoveDistance(void) const
	{
	    return m_dmove;
	}
	...
	void SetMoveDistance(const double dmove)
	{
	    m_dmove = dmove;
	}
