...
namespace Antipatrea
{
	...
	double GetMinUnit(void) const
	{
	    return m_minUnit;
	}

	double GetMaxUnit(void) const
	{
	    return m_maxUnit;
	}
	...
	virtual bool IsPointInside(const double p[], const double poff = 0.0) const;
	...
	virtual double GetDiagonal(void) const
	{
	    return Algebra::PointDistance(GetNrDims(), GetMin(), GetMax());
	}
	...
	virtual void DrawCell(const int id) const;
