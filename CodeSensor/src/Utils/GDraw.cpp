...
namespace Antipatrea
{
	...
	GDrawData(void)
	{
	    ...
	    m_params[GDRAW_POINT_SIZE] = Constants::GRAPHICS_POINT_SIZE;	    
	}
	...
	d->m_params[GDRAW_POINT_SIZE] = p.GetValueAsDouble(Constants::KW_PointSize, d->m_params[GDRAW_POINT_SIZE]);
